...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/body.css?after">
<meta charset="UTF-8">
...
style="width:50px;height:50px"></a></div>
	...
	<li><a href="/user/logout" class="navitems">로그아웃</a></li>
	<li><a href="/user/mydetail" class="navitems">내정보</a></li>
	<li><a href="/board/register" class="navitems">게시글 쓰기</a></li>
</c:if>     
        </ul>
    </nav>
</div>
